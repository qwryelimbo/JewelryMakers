...
if __name__ == '__main__':
    ...
    if result == 0:
        ...
        print("Проверьте вывод выше для получения информации об ошибках.")
        print(f"Скриншоты с ошибками доступны в: {screenshots_dir}")
        print("\nСоветы по устранению ошибок:")
        print("1. Проверьте, что Chrome установлен и доступен")
        print("2. Убедитесь, что приложение Flask запускается корректно")
        print("3. Проверьте селекторы HTML элементов в тестах")
        print("4. Увеличьте время ожидания для медленных компьютеров")
